  ...
  <div class="body">
    <div class="main">
      <section>
        ...
        <p class="lead">Начинающий разработчик с фокусом на backend-разработке, корпоративных информационных системах (KIS/ERP), архитектуре ПО и интеграции искусственного интеллекта. Программированием увлекаюсь со школьных лет и постоянно осваиваю новые технологии на практике — через собственные проекты. Сейчас основной фокус — система BetaKIS на Go и применение современных AI-технологий.</p>
      </section>
    ...
    <aside class="side">
      ...
      <section>
        ...
        <ul class="mini">
          <li>Программирую со школьных лет</li>
